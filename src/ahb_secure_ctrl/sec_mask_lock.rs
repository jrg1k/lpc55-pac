...
pub type SecCpu1IntMask0LockW<'a, REG> =
    crate::FieldWriter<'a, REG, 2, SecCpu1IntMask0Lock>;
...
pub type SecCpu1IntMask1LockW<'a, REG> =
    crate::FieldWriter<'a, REG, 2, SecCpu1IntMask1Lock>;
