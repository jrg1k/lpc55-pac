...
pub type AhbSecCtrlRuleW<'a, REG> =
    crate::FieldWriter<'a, REG, 2, AhbSecCtrlRule, crate::Safe>;
...
impl W {
    ...
    #[doc = "Bits 4:5 - AHB Secure Controller"]
    #[inline(always)]
    pub fn ahb_sec_ctrl_rule(
        &mut self,
    ) -> AhbSecCtrlRuleW<SecCtrlAhbPort10Slave1RuleSpec> {
