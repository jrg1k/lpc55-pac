...
pub type R = crate::R<Ahbclkctrl2Spec>;
#[doc = "Register `AHBCLKCTRL2` writer"]
pub type W = crate::W<Ahbclkctrl2Spec>;
...
impl W {
    #[doc = "Bit 1 - Enables the clock for the DMA1."]
    #[inline(always)]
    pub fn dma1(&mut self) -> Dma1W<Ahbclkctrl2Spec> {
        Dma1W::new(self, 1)
    }
    #[doc = "Bit 2 - Enables the clock for the Comparator."]
    #[inline(always)]
    pub fn comp(&mut self) -> CompW<Ahbclkctrl2Spec> {
        CompW::new(self, 2)
    }
    #[doc = "Bit 3 - Enables the clock for the SDIO."]
    #[inline(always)]
    pub fn sdio(&mut self) -> SdioW<Ahbclkctrl2Spec> {
        SdioW::new(self, 3)
    }
    #[doc = "Bit 4 - Enables the clock for the USB1 Host."]
    #[inline(always)]
    pub fn usb1_host(&mut self) -> Usb1HostW<Ahbclkctrl2Spec> {
        Usb1HostW::new(self, 4)
    }
    #[doc = "Bit 5 - Enables the clock for the USB1 dev."]
    #[inline(always)]
    pub fn usb1_dev(&mut self) -> Usb1DevW<Ahbclkctrl2Spec> {
        Usb1DevW::new(self, 5)
    }
    #[doc = "Bit 6 - Enables the clock for the USB1 RAM."]
    #[inline(always)]
    pub fn usb1_ram(&mut self) -> Usb1RamW<Ahbclkctrl2Spec> {
        Usb1RamW::new(self, 6)
    }
    #[doc = "Bit 7 - Enables the clock for the USB1 PHY."]
    #[inline(always)]
    pub fn usb1_phy(&mut self) -> Usb1PhyW<Ahbclkctrl2Spec> {
        Usb1PhyW::new(self, 7)
    }
    #[doc = "Bit 8 - Enables the clock for the Frequency meter."]
    #[inline(always)]
    pub fn freqme(&mut self) -> FreqmeW<Ahbclkctrl2Spec> {
        FreqmeW::new(self, 8)
    }
    #[doc = "Bit 13 - Enables the clock for the RNG."]
    #[inline(always)]
    pub fn rng(&mut self) -> RngW<Ahbclkctrl2Spec> {
        RngW::new(self, 13)
    }
    #[doc = "Bit 15 - SYSCTL block clock."]
    #[inline(always)]
    pub fn sysctl(&mut self) -> SysctlW<Ahbclkctrl2Spec> {
        SysctlW::new(self, 15)
    }
    #[doc = "Bit 16 - Enables the clock for the USB0 Host Master."]
    #[inline(always)]
    pub fn usb0_hostm(&mut self) -> Usb0HostmW<Ahbclkctrl2Spec> {
        Usb0HostmW::new(self, 16)
    }
    #[doc = "Bit 17 - Enables the clock for the USB0 Host Slave."]
    #[inline(always)]
    pub fn usb0_hosts(&mut self) -> Usb0HostsW<Ahbclkctrl2Spec> {
        Usb0HostsW::new(self, 17)
    }
    #[doc = "Bit 18 - Enables the clock for the HASH_AES."]
    #[inline(always)]
    pub fn hash_aes(&mut self) -> HashAesW<Ahbclkctrl2Spec> {
        HashAesW::new(self, 18)
    }
    #[doc = "Bit 19 - Enables the clock for the Power Quad."]
    #[inline(always)]
    pub fn pq(&mut self) -> PqW<Ahbclkctrl2Spec> {
        PqW::new(self, 19)
    }
    #[doc = "Bit 20 - Enables the clock for the PLU LUT."]
    #[inline(always)]
    pub fn plulut(&mut self) -> PlulutW<Ahbclkctrl2Spec> {
        PlulutW::new(self, 20)
    }
    #[doc = "Bit 21 - Enables the clock for the Timer 3."]
    #[inline(always)]
    pub fn timer3(&mut self) -> Timer3W<Ahbclkctrl2Spec> {
        Timer3W::new(self, 21)
    }
    #[doc = "Bit 22 - Enables the clock for the Timer 4."]
    #[inline(always)]
    pub fn timer4(&mut self) -> Timer4W<Ahbclkctrl2Spec> {
        Timer4W::new(self, 22)
    }
    #[doc = "Bit 23 - Enables the clock for the PUF reset control."]
    #[inline(always)]
    pub fn puf(&mut self) -> PufW<Ahbclkctrl2Spec> {
        PufW::new(self, 23)
    }
    #[doc = "Bit 24 - Enables the clock for the Casper."]
    #[inline(always)]
    pub fn casper(&mut self) -> CasperW<Ahbclkctrl2Spec> {
        CasperW::new(self, 24)
    }
    #[doc = "Bit 27 - Enables the clock for the analog control."]
    #[inline(always)]
    pub fn analog_ctrl(&mut self) -> AnalogCtrlW<Ahbclkctrl2Spec> {
        AnalogCtrlW::new(self, 27)
    }
    #[doc = "Bit 28 - Enables the clock for the HS LSPI."]
    #[inline(always)]
    pub fn hs_lspi(&mut self) -> HsLspiW<Ahbclkctrl2Spec> {
        HsLspiW::new(self, 28)
    }
    #[doc = "Bit 29 - Enables the clock for the GPIO secure."]
    #[inline(always)]
    pub fn gpio_sec(&mut self) -> GpioSecW<Ahbclkctrl2Spec> {
        GpioSecW::new(self, 29)
    }
    #[doc = "Bit 30 - Enables the clock for the GPIO secure int."]
    #[inline(always)]
    pub fn gpio_sec_int(&mut self) -> GpioSecIntW<Ahbclkctrl2Spec> {
        GpioSecIntW::new(self, 30)
    }
}
#[doc = "AHB Clock control 2\n\nYou can [`read`](crate::Reg::read) this register and get [`ahbclkctrl2::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ahbclkctrl2::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Ahbclkctrl2Spec;
impl crate::RegisterSpec for Ahbclkctrl2Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ahbclkctrl2::R`](R) reader structure"]
impl crate::Readable for Ahbclkctrl2Spec {}
#[doc = "`write(|w| ..)` method takes [`ahbclkctrl2::W`](W) writer structure"]
impl crate::Writable for Ahbclkctrl2Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets AHBCLKCTRL2 to value 0"]
impl crate::Resettable for Ahbclkctrl2Spec {
