...
pub type R = crate::R<Fcclksel4Spec>;
#[doc = "Register `FCCLKSEL4` writer"]
pub type W = crate::W<Fcclksel4Spec>;
...
impl W {
    #[doc = "Bits 0:2 - Flexcomm Interface 4 clock source select for Fractional Rate Divider."]
    #[inline(always)]
    pub fn sel(&mut self) -> SelW<Fcclksel4Spec> {
        SelW::new(self, 0)
    }
}
#[doc = "Flexcomm Interface 4 clock source select for Fractional Rate Divider\n\nYou can [`read`](crate::Reg::read) this register and get [`fcclksel4::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`fcclksel4::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Fcclksel4Spec;
impl crate::RegisterSpec for Fcclksel4Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`fcclksel4::R`](R) reader structure"]
impl crate::Readable for Fcclksel4Spec {}
#[doc = "`write(|w| ..)` method takes [`fcclksel4::W`](W) writer structure"]
impl crate::Writable for Fcclksel4Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets FCCLKSEL4 to value 0x07"]
impl crate::Resettable for Fcclksel4Spec {
