...
pub type R = crate::R<Presetctrl2Spec>;
#[doc = "Register `PRESETCTRL2` writer"]
pub type W = crate::W<Presetctrl2Spec>;
...
impl W {
    #[doc = "Bit 1 - DMA1 reset control."]
    #[inline(always)]
    pub fn dma1_rst(&mut self) -> Dma1RstW<Presetctrl2Spec> {
        Dma1RstW::new(self, 1)
    }
    #[doc = "Bit 2 - Comparator reset control."]
    #[inline(always)]
    pub fn comp_rst(&mut self) -> CompRstW<Presetctrl2Spec> {
        CompRstW::new(self, 2)
    }
    #[doc = "Bit 3 - SDIO reset control."]
    #[inline(always)]
    pub fn sdio_rst(&mut self) -> SdioRstW<Presetctrl2Spec> {
        SdioRstW::new(self, 3)
    }
    #[doc = "Bit 4 - USB1 Host reset control."]
    #[inline(always)]
    pub fn usb1_host_rst(&mut self) -> Usb1HostRstW<Presetctrl2Spec> {
        Usb1HostRstW::new(self, 4)
    }
    #[doc = "Bit 5 - USB1 dev reset control."]
    #[inline(always)]
    pub fn usb1_dev_rst(&mut self) -> Usb1DevRstW<Presetctrl2Spec> {
        Usb1DevRstW::new(self, 5)
    }
    #[doc = "Bit 6 - USB1 RAM reset control."]
    #[inline(always)]
    pub fn usb1_ram_rst(&mut self) -> Usb1RamRstW<Presetctrl2Spec> {
        Usb1RamRstW::new(self, 6)
    }
    #[doc = "Bit 7 - USB1 PHY reset control."]
    #[inline(always)]
    pub fn usb1_phy_rst(&mut self) -> Usb1PhyRstW<Presetctrl2Spec> {
        Usb1PhyRstW::new(self, 7)
    }
    #[doc = "Bit 8 - Frequency meter reset control."]
    #[inline(always)]
    pub fn freqme_rst(&mut self) -> FreqmeRstW<Presetctrl2Spec> {
        FreqmeRstW::new(self, 8)
    }
    #[doc = "Bit 13 - RNG reset control."]
    #[inline(always)]
    pub fn rng_rst(&mut self) -> RngRstW<Presetctrl2Spec> {
        RngRstW::new(self, 13)
    }
    #[doc = "Bit 15 - SYSCTL Block reset."]
    #[inline(always)]
    pub fn sysctl_rst(&mut self) -> SysctlRstW<Presetctrl2Spec> {
        SysctlRstW::new(self, 15)
    }
    #[doc = "Bit 16 - USB0 Host Master reset control."]
    #[inline(always)]
    pub fn usb0_hostm_rst(&mut self) -> Usb0HostmRstW<Presetctrl2Spec> {
        Usb0HostmRstW::new(self, 16)
    }
    #[doc = "Bit 17 - USB0 Host Slave reset control."]
    #[inline(always)]
    pub fn usb0_hosts_rst(&mut self) -> Usb0HostsRstW<Presetctrl2Spec> {
        Usb0HostsRstW::new(self, 17)
    }
    #[doc = "Bit 18 - HASH_AES reset control."]
    #[inline(always)]
    pub fn hash_aes_rst(&mut self) -> HashAesRstW<Presetctrl2Spec> {
        HashAesRstW::new(self, 18)
    }
    #[doc = "Bit 19 - Power Quad reset control."]
    #[inline(always)]
    pub fn pq_rst(&mut self) -> PqRstW<Presetctrl2Spec> {
        PqRstW::new(self, 19)
    }
    #[doc = "Bit 20 - PLU LUT reset control."]
    #[inline(always)]
    pub fn plulut_rst(&mut self) -> PlulutRstW<Presetctrl2Spec> {
        PlulutRstW::new(self, 20)
    }
    #[doc = "Bit 21 - Timer 3 reset control."]
    #[inline(always)]
    pub fn timer3_rst(&mut self) -> Timer3RstW<Presetctrl2Spec> {
        Timer3RstW::new(self, 21)
    }
    #[doc = "Bit 22 - Timer 4 reset control."]
    #[inline(always)]
    pub fn timer4_rst(&mut self) -> Timer4RstW<Presetctrl2Spec> {
        Timer4RstW::new(self, 22)
    }
    #[doc = "Bit 23 - PUF reset control reset control."]
    #[inline(always)]
    pub fn puf_rst(&mut self) -> PufRstW<Presetctrl2Spec> {
        PufRstW::new(self, 23)
    }
    #[doc = "Bit 24 - Casper reset control."]
    #[inline(always)]
    pub fn casper_rst(&mut self) -> CasperRstW<Presetctrl2Spec> {
        CasperRstW::new(self, 24)
    }
    #[doc = "Bit 27 - analog control reset control."]
    #[inline(always)]
    pub fn analog_ctrl_rst(&mut self) -> AnalogCtrlRstW<Presetctrl2Spec> {
        AnalogCtrlRstW::new(self, 27)
    }
    #[doc = "Bit 28 - HS LSPI reset control."]
    #[inline(always)]
    pub fn hs_lspi_rst(&mut self) -> HsLspiRstW<Presetctrl2Spec> {
        HsLspiRstW::new(self, 28)
    }
    #[doc = "Bit 29 - GPIO secure reset control."]
    #[inline(always)]
    pub fn gpio_sec_rst(&mut self) -> GpioSecRstW<Presetctrl2Spec> {
        GpioSecRstW::new(self, 29)
    }
    #[doc = "Bit 30 - GPIO secure int reset control."]
    #[inline(always)]
    pub fn gpio_sec_int_rst(&mut self) -> GpioSecIntRstW<Presetctrl2Spec> {
        GpioSecIntRstW::new(self, 30)
    }
}
#[doc = "Peripheral reset control 2\n\nYou can [`read`](crate::Reg::read) this register and get [`presetctrl2::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`presetctrl2::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Presetctrl2Spec;
impl crate::RegisterSpec for Presetctrl2Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`presetctrl2::R`](R) reader structure"]
impl crate::Readable for Presetctrl2Spec {}
#[doc = "`write(|w| ..)` method takes [`presetctrl2::W`](W) writer structure"]
impl crate::Writable for Presetctrl2Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets PRESETCTRL2 to value 0"]
impl crate::Resettable for Presetctrl2Spec {
