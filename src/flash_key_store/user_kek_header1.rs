...
pub type R = crate::R<UserKekHeader1Spec>;
#[doc = "Register `USER_KEK_HEADER1` writer"]
pub type W = crate::W<UserKekHeader1Spec>;
...
impl W {
    #[doc = "Bits 0:1 - ."]
    #[inline(always)]
    pub fn type_(&mut self) -> TypeW<UserKekHeader1Spec> {
        TypeW::new(self, 0)
    }
    #[doc = "Bits 8:11 - ."]
    #[inline(always)]
    pub fn index(&mut self) -> IndexW<UserKekHeader1Spec> {
        IndexW::new(self, 8)
    }
    #[doc = "Bits 24:29 - ."]
    #[inline(always)]
    pub fn size(&mut self) -> SizeW<UserKekHeader1Spec> {
        SizeW::new(self, 24)
    }
}
#[doc = ".\n\nYou can [`read`](crate::Reg::read) this register and get [`user_kek_header1::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`user_kek_header1::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct UserKekHeader1Spec;
impl crate::RegisterSpec for UserKekHeader1Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`user_kek_header1::R`](R) reader structure"]
impl crate::Readable for UserKekHeader1Spec {}
#[doc = "`write(|w| ..)` method takes [`user_kek_header1::W`](W) writer structure"]
impl crate::Writable for UserKekHeader1Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets USER_KEK_HEADER1 to value 0"]
impl crate::Resettable for UserKekHeader1Spec {
