...
pub type Apbbridge0RuleW<'a, REG> =
    crate::FieldWriter<'a, REG, 2, Apbbridge0Rule, crate::Safe>;
...
pub type Apbbridge1RuleW<'a, REG> =
    crate::FieldWriter<'a, REG, 2, Apbbridge1Rule, crate::Safe>;
...
impl W {
    #[doc = "Bits 0:1 - Security access rules for the whole APB Bridge 0"]
    #[inline(always)]
    pub fn apbbridge0_rule(
        &mut self,
    ) -> Apbbridge0RuleW<SecCtrlApbBridgeSlaveRuleSpec> {
        Apbbridge0RuleW::new(self, 0)
    }
    #[doc = "Bits 4:5 - Security access rules for the whole APB Bridge 1"]
    #[inline(always)]
    pub fn apbbridge1_rule(
        &mut self,
    ) -> Apbbridge1RuleW<SecCtrlApbBridgeSlaveRuleSpec> {
