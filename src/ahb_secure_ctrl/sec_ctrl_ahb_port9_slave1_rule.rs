...
pub type Flexcomm7RuleW<'a, REG> =
    crate::FieldWriter<'a, REG, 2, Flexcomm7Rule, crate::Safe>;
...
pub type DbgMailboxRuleW<'a, REG> =
    crate::FieldWriter<'a, REG, 2, DbgMailboxRule, crate::Safe>;
...
impl W {
    ...
    #[doc = "Bits 16:17 - Debug mailbox (aka ISP-AP)"]
    #[inline(always)]
    pub fn dbg_mailbox_rule(
        &mut self,
    ) -> DbgMailboxRuleW<SecCtrlAhbPort9Slave1RuleSpec> {
