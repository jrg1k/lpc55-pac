...
pub type R = crate::R<Fcclksel7Spec>;
#[doc = "Register `FCCLKSEL7` writer"]
pub type W = crate::W<Fcclksel7Spec>;
...
impl W {
    #[doc = "Bits 0:2 - Flexcomm Interface 7 clock source select for Fractional Rate Divider."]
    #[inline(always)]
    pub fn sel(&mut self) -> SelW<Fcclksel7Spec> {
        SelW::new(self, 0)
    }
}
#[doc = "Flexcomm Interface 7 clock source select for Fractional Rate Divider\n\nYou can [`read`](crate::Reg::read) this register and get [`fcclksel7::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`fcclksel7::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Fcclksel7Spec;
impl crate::RegisterSpec for Fcclksel7Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`fcclksel7::R`](R) reader structure"]
impl crate::Readable for Fcclksel7Spec {}
#[doc = "`write(|w| ..)` method takes [`fcclksel7::W`](W) writer structure"]
impl crate::Writable for Fcclksel7Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets FCCLKSEL7 to value 0x07"]
impl crate::Resettable for Fcclksel7Spec {
