...
pub type Ctimer0RuleW<'a, REG> =
    crate::FieldWriter<'a, REG, 2, Ctimer0Rule, crate::Safe>;
...
pub type Ctimer1RuleW<'a, REG> =
    crate::FieldWriter<'a, REG, 2, Ctimer1Rule, crate::Safe>;
