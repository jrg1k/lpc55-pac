...
pub type R = crate::R<Presetctrl1Spec>;
#[doc = "Register `PRESETCTRL1` writer"]
pub type W = crate::W<Presetctrl1Spec>;
...
impl W {
    #[doc = "Bit 0 - MRT reset control."]
    #[inline(always)]
    pub fn mrt_rst(&mut self) -> MrtRstW<Presetctrl1Spec> {
        MrtRstW::new(self, 0)
    }
    #[doc = "Bit 1 - OS Event Timer reset control."]
    #[inline(always)]
    pub fn ostimer_rst(&mut self) -> OstimerRstW<Presetctrl1Spec> {
        OstimerRstW::new(self, 1)
    }
    #[doc = "Bit 2 - SCT reset control."]
    #[inline(always)]
    pub fn sct_rst(&mut self) -> SctRstW<Presetctrl1Spec> {
        SctRstW::new(self, 2)
    }
    #[doc = "Bit 6 - SCTIPU reset control."]
    #[inline(always)]
    pub fn sctipu_rst(&mut self) -> SctipuRstW<Presetctrl1Spec> {
        SctipuRstW::new(self, 6)
    }
    #[doc = "Bit 10 - UTICK reset control."]
    #[inline(always)]
    pub fn utick_rst(&mut self) -> UtickRstW<Presetctrl1Spec> {
        UtickRstW::new(self, 10)
    }
    #[doc = "Bit 11 - FC0 reset control."]
    #[inline(always)]
    pub fn fc0_rst(&mut self) -> Fc0RstW<Presetctrl1Spec> {
        Fc0RstW::new(self, 11)
    }
    #[doc = "Bit 12 - FC1 reset control."]
    #[inline(always)]
    pub fn fc1_rst(&mut self) -> Fc1RstW<Presetctrl1Spec> {
        Fc1RstW::new(self, 12)
    }
    #[doc = "Bit 13 - FC2 reset control."]
    #[inline(always)]
    pub fn fc2_rst(&mut self) -> Fc2RstW<Presetctrl1Spec> {
        Fc2RstW::new(self, 13)
    }
    #[doc = "Bit 14 - FC3 reset control."]
    #[inline(always)]
    pub fn fc3_rst(&mut self) -> Fc3RstW<Presetctrl1Spec> {
        Fc3RstW::new(self, 14)
    }
    #[doc = "Bit 15 - FC4 reset control."]
    #[inline(always)]
    pub fn fc4_rst(&mut self) -> Fc4RstW<Presetctrl1Spec> {
        Fc4RstW::new(self, 15)
    }
    #[doc = "Bit 16 - FC5 reset control."]
    #[inline(always)]
    pub fn fc5_rst(&mut self) -> Fc5RstW<Presetctrl1Spec> {
        Fc5RstW::new(self, 16)
    }
    #[doc = "Bit 17 - FC6 reset control."]
    #[inline(always)]
    pub fn fc6_rst(&mut self) -> Fc6RstW<Presetctrl1Spec> {
        Fc6RstW::new(self, 17)
    }
    #[doc = "Bit 18 - FC7 reset control."]
    #[inline(always)]
    pub fn fc7_rst(&mut self) -> Fc7RstW<Presetctrl1Spec> {
        Fc7RstW::new(self, 18)
    }
    #[doc = "Bit 22 - Timer 2 reset control."]
    #[inline(always)]
    pub fn timer2_rst(&mut self) -> Timer2RstW<Presetctrl1Spec> {
        Timer2RstW::new(self, 22)
    }
    #[doc = "Bit 25 - USB0 DEV reset control."]
    #[inline(always)]
    pub fn usb0_dev_rst(&mut self) -> Usb0DevRstW<Presetctrl1Spec> {
        Usb0DevRstW::new(self, 25)
    }
    #[doc = "Bit 26 - Timer 0 reset control."]
    #[inline(always)]
    pub fn timer0_rst(&mut self) -> Timer0RstW<Presetctrl1Spec> {
        Timer0RstW::new(self, 26)
    }
    #[doc = "Bit 27 - Timer 1 reset control."]
    #[inline(always)]
    pub fn timer1_rst(&mut self) -> Timer1RstW<Presetctrl1Spec> {
        Timer1RstW::new(self, 27)
    }
}
#[doc = "Peripheral reset control 1\n\nYou can [`read`](crate::Reg::read) this register and get [`presetctrl1::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`presetctrl1::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Presetctrl1Spec;
impl crate::RegisterSpec for Presetctrl1Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`presetctrl1::R`](R) reader structure"]
impl crate::Readable for Presetctrl1Spec {}
#[doc = "`write(|w| ..)` method takes [`presetctrl1::W`](W) writer structure"]
impl crate::Writable for Presetctrl1Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets PRESETCTRL1 to value 0"]
impl crate::Resettable for Presetctrl1Spec {
