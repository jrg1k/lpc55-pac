...
pub type R = crate::R<PrinceRegion1IvHeader1Spec>;
#[doc = "Register `PRINCE_REGION1_IV_HEADER1` writer"]
pub type W = crate::W<PrinceRegion1IvHeader1Spec>;
...
impl W {
    #[doc = "Bits 0:1 - no description available"]
    #[inline(always)]
    pub fn type_(&mut self) -> TypeW<PrinceRegion1IvHeader1Spec> {
        TypeW::new(self, 0)
    }
    #[doc = "Bits 8:11 - no description available"]
    #[inline(always)]
    pub fn index(&mut self) -> IndexW<PrinceRegion1IvHeader1Spec> {
        IndexW::new(self, 8)
    }
    #[doc = "Bits 24:29 - no description available"]
    #[inline(always)]
    pub fn size(&mut self) -> SizeW<PrinceRegion1IvHeader1Spec> {
        SizeW::new(self, 24)
    }
}
#[doc = "no description available\n\nYou can [`read`](crate::Reg::read) this register and get [`prince_region1_iv_header1::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`prince_region1_iv_header1::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct PrinceRegion1IvHeader1Spec;
impl crate::RegisterSpec for PrinceRegion1IvHeader1Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`prince_region1_iv_header1::R`](R) reader structure"]
impl crate::Readable for PrinceRegion1IvHeader1Spec {}
#[doc = "`write(|w| ..)` method takes [`prince_region1_iv_header1::W`](W) writer structure"]
impl crate::Writable for PrinceRegion1IvHeader1Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets PRINCE_REGION1_IV_HEADER1 to value 0"]
impl crate::Resettable for PrinceRegion1IvHeader1Spec {
